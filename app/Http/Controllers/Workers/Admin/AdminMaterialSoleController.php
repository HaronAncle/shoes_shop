...
use App\Models\MaterialSole;
use Illuminate\Http\Request;

class AdminMaterialSoleController extends Controller
{
    public function index()
    {
        $materials = MaterialSole::all();
    ...
    public function store(Request $request)
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $material = MaterialSole::findOrFail($id);
            $material->title = $validatedData['title'];
            $material->search_title = $validatedData['searchTitle'];
            $material->save();
